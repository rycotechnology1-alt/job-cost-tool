...
class ApiSettings:
    ...
    def from_env(cls, env: Mapping[str, str] | None = None) -> "ApiSettings":
        ...
        raw_export_retention_hours = str(environ.get("JOB_COST_API_EXPORT_RETENTION_HOURS", "24")).strip()
        export_retention_hours = int(raw_export_retention_hours or "24")
        ...
        *,
        ...
        return ApiSettings(
            ...
            export_retention_hours=(
                self.export_retention_hours if export_retention_hours is None else int(export_retention_hours)
            ),
